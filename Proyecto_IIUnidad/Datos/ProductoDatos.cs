...
namespace Datos
{
    public class ProductoDatos
    {
        ...
        public async Task<bool> ActualizarAsync(Producto producto)
        {
            ...
            try
            {
                string sql = "UPDATE producto SET Descripcio=@Descripcio, Existencia=@Existencia, Precio=@Precio, FechaCreacion=@FechaCreacion, Imagen=@Imagen WHERE Codigo=@Codigo;";
        ...
        public async Task<bool> EliminarAsync(string codigo)
        {
            ...
            try
            {
                string sql = "DELETE producto WHERE Codigo =@Codigo;";
